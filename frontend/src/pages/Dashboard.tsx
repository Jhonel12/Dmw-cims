...
const Dashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    setIsLoading(true);
    try {
      // Load statistics and recent departures in parallel
  ...
  const stats = statistics ? [
    ...
    { 
      ...
      value: statistics.recent_departures.toLocaleString(), 
      change: '+8%', 
      changeType: 'positive',
    ...
    { 
      ...
      value: statistics.by_country.length.toString(), 
      change: '+2', 
      changeType: 'positive',
  ...
  const quickActions = [
    ...
    },
    {
      ...
      description: 'Find specific OFW records',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
